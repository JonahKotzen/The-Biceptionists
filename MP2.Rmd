...
```{r chunk8, include=TRUE}
# Assuming g = 9.81 m/s^2
g <- 9.81

# Adding the max_mass calculation to your existing mutate call
arm_dat_expanded <- arm_dat_expanded %>%
  mutate(
    # Compute max_mass based on the torque and out-lever length
    max_mass = tau_muscle / (Lout * g)
  )
