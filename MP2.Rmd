...
In gym testing, we were on average able to lift more than the model predicted. Ari was able to lift approximately 2.3 kg above the calculated max mass, and Scarlett was able to lift approximately 2.5 kg above the calculated max mass. Opposite of two participants, Jonah lifted approximately 2.7 kg under the predicted max mass. This could be due to over approximation of bicep mass in addition to inaccurate conversion when at the gym.

This discrepancy could be due to the model not accounting for synergistic muscle actions, neural adaptations, individual biomechanical differences, and psychological factors that can enhance performance. Essentially, real-world performance can exceed model predictions due to the complex interplay of physiological and psychological factors not fully captured by the model. Additionally, other muscles present in the upper arm and shoulder could have compensated for the bicep and aided in the lifting, resulting in participants being able to lift on average a heavier mass than predicted. 

Many advancements have been made in the the analysis of musculoskeletal systems, including the Hill-type muscle model studied by @hill1938heat and the force and muscle length approximation equation studied by @whiting1999theoretical. However our data shows how more research must be done in order to better analyze and predict how skeletal geometry and muscle length and mass affect both the force output in the forelimb and the maximum load it can support. 
